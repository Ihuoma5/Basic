...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Add Device Page </h4><br><br>



 <form method="post" action="{{ route('device.store') }}" id="myForm" >
                @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="trueprep" class="form-control" type="text"    >
                </div>
            </div>
            <!-- end row -->
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="truelab" class="form-control" type="text"    >
                </div>
            </div>
            <!-- end row -->
            <div class="row md-3">
                ...
                <div class="form-group col-sm-10">
                 <input class="form-control col-sm-10 example-date-input" name="date" type="date"  id="date"></div>
            </div>
            <!-- end row -->
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Add Device">
            </form>
